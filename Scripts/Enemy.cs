...
public class Enemy : Worker
{
    ...
    //protected override void OnPathFound(List<Vector2> newPath, bool pathSuccessful, float distance)
    //{
    ...
    //        if (path.Count > 0)
    //        {
    //            RaycastHit2D ray = Physics2D.Raycast(path[path.Count - 1], Vector2.zero);
    ...
    //public override void IsMovingAnimation(bool moving)
    //{
    //    if (moving)
    //    {
